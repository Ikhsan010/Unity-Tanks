...
{
    public float m_DampTime = 0.2f;          //the aprox time it takes for the camera to move to the position it is required to be in
    ...
    private void FindAveragePosition()
    {
        ...
        {
            if (!m_Targets[i].gameObject.activeSelf) //if the tank is active, continue with the next step in the loop
                continue;
